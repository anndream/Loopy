...
bool FFMpegExtractor::createAVIOContext(AMediaExtractor extractor, uint8_t *buffer, uint32_t bufferSize,
    ...
    *avioContext = avio_alloc_context(
            ...
            isBufferWriteable,
            extractor, // Will be passed to our callback functions as a (void *)
...
int64_t FFMpegExtractor::decode(
    ...
    };
    {
        ...
        if (!createAVIOContext(extractor, buffer, kInternalBufferSize, &tmp)){
