...
bool AudioEngine::setupSource() {
    ...
    std::shared_ptr<StorageDataSource> loopSource{
            StorageDataSource::newFromCompressedAsset( x, targetProperties)
    };
...
//        mPlayStream->setBufferSizeInFrames(mFramesPerBurst * 2);
//
