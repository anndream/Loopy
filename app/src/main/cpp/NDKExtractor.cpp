...
int32_t
NDKExtractor::decode(const char *asset, uint8_t *targetData, AudioProperties targetProperties) {
...
//    int fd = AAsset_openFileDescriptor(asset, &start, &length);
    ...
    media_status_t amresult = AMediaExtractor_setDataSource(extractor, asset);
