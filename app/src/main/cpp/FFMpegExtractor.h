...
public:
    ...
    static int64_t decode2(FILE *file, uint8_t *targetData, AudioProperties targetProperties);
...
private:
    ...
    static bool
    createAVIOContext2(FILE *file, uint8_t *buffer, uint32_t bufferSize, AVIOContext **avioContext);
};
