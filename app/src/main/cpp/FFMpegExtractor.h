...
public:
    static int64_t decode(AMediaExtractor &extractor, uint8_t *targetData, AudioProperties targetProperties);

private:
    static bool createAVIOContext(AMediaExtractor &extractor, uint8_t *buffer, uint32_t bufferSize,
